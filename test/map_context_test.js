...
var interpolator = require('../js/map_interpolator');

describe('GetNeighboringCellsWithWeights(Simple)', function() {
  // Cells with size=1.
  let map_ctx = new interpolator.MapInterpolator(window_size = 5, num_cells = 5);
...
describe('GetNeighboringCellsWithWeights', function() {
  let map_ctx = new interpolator.MapInterpolator(window_size = 10, num_cells = 5);
  let cell_size = map_ctx.cell_size;
...
describe('GetInterpolatedValue2D', function() {
  let map_ctx = new interpolator.MapInterpolator(window_size = 10, num_cells = 2);
